//Find the minimal number of platforms necessary to prevent delays in any train's arrival given a schedule with the arrival and departure times of trains at a station. - Greedy Approach
